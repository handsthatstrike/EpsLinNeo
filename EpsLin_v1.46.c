...
//
//  v.1.4x:
//        - TODO: eliminate case-sensitivity on Windows
//                when *.EFE is used as input (strcasecmp?)
//
//  v.1.46:
...
//                    files (IMG, EFE, EDE, et al) was lessened.
...
#ifdef __CYGWIN__
#define VERSION     "v1.46 (Beta for Windows)"
#else
...
// IsEFE
//------
// Checks if file extension is proper for Giebler EFE or EFA.
// Does no actual checking of header information, or other safety 
// control attempts.
...
int FormatMedia(char **argv, int argc, int optind, char format_arg, char *disk_label)
{
  ...
  switch(format_arg)
	...
	fflush(stdout);
      ...
      //Write null block (block 0) with additional information.
